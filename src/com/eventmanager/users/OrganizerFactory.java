...
public class OrganizerFactory implements UserAbstractFactory {
	...
	public OrganizerFactory(String firstName, String lastName, Enum<UserType> userType, String emailAddress, String password) {
	...
	public OrganizerFactory(String userId, String firstName, String lastName, Enum<UserType> userType, String emailAddress) {
		this.userId = userId;
		this.firstName = firstName;
		this.lastName = lastName;
		this.userType = userType;

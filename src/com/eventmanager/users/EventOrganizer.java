...
public class EventOrganizer extends User {
	...
	public EventOrganizer(String firstName, String lastName, Enum<UserType> userType, String emailAddress, String password) {
	...
	public EventOrganizer(String userId, String firstName, String lastName, Enum<UserType> userType, String emailAddress) {
		this.userId = userId;
		this.firstName = firstName;
		this.lastName = lastName;
		this.userType = userType;
